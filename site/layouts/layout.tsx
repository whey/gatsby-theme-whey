...
const Layout: React.FC<LayoutProps> = ({ children, location }) => {
  ...
  return (
    <>
      ...
      <Seo
        title={siteUrl === 'https://docs.townsuite.com' ? '' : title}
        lang={i18n.language}
      />
      <Header
        subTitle={siteUrl === 'https://docs.townsuite.com' ? '' : title}
        path={path}
      ...
      <Footer githubUrl={githubUrl} rootDomain="https://docs.townsuite.com" />
    </>
  );
};
